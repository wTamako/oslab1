...
void print_regs(struct pushregs *gpr) {
    ...
    802001a2:	b4a50513          	addi	a0,a0,-1206 # 80200ce8 <etext+0x276>
void print_regs(struct pushregs *gpr) {
    ...
    8020035a:	c7a50513          	addi	a0,a0,-902 # 80200fd0 <etext+0x55e>
}
...
void print_trapframe(struct trapframe *tf) {
    ...
    80200370:	c7c50513          	addi	a0,a0,-900 # 80200fe8 <etext+0x576>
void print_trapframe(struct trapframe *tf) {
    ...
    802003bc:	c9050513          	addi	a0,a0,-880 # 80201048 <etext+0x5d6>
}
...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003ec:	8b050513          	addi	a0,a0,-1872 # 80200c98 <etext+0x226>
    802003f0:	c7dff06f          	j	8020006c <cprintf>
            cprintf("Hypervisor software interrupt\n");
    802003f4:	00001517          	auipc	a0,0x1
    802003f8:	88450513          	addi	a0,a0,-1916 # 80200c78 <etext+0x206>
    802003fc:	c71ff06f          	j	8020006c <cprintf>
            cprintf("User software interrupt\n");
    80200400:	00001517          	auipc	a0,0x1
    80200404:	83850513          	addi	a0,a0,-1992 # 80200c38 <etext+0x1c6>
    80200408:	c65ff06f          	j	8020006c <cprintf>
            cprintf("Supervisor software interrupt\n");
    8020040c:	00001517          	auipc	a0,0x1
    80200410:	84c50513          	addi	a0,a0,-1972 # 80200c58 <etext+0x1e6>
    ...
    8020041c:	8b050513          	addi	a0,a0,-1872 # 80200cc8 <etext+0x256>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200430:	bec70713          	addi	a4,a4,-1044 # 80204018 <ticks>
    80200434:	631c                	ld	a5,0(a4)
            if (ticks == TICK_NUM) {
    80200436:	06400693          	li	a3,100
            ticks++;
    8020043a:	0785                	addi	a5,a5,1
    8020043c:	00004617          	auipc	a2,0x4
    80200440:	bcf63e23          	sd	a5,-1060(a2) # 80204018 <ticks>
            if (ticks == TICK_NUM) {
    80200444:	631c                	ld	a5,0(a4)
    80200446:	00d78763          	beq	a5,a3,80200454 <interrupt_handler+0x8e>
            break;
        default:
            print_trapframe(tf);
            break;
    ...
    80200458:	86450513          	addi	a0,a0,-1948 # 80200cb8 <etext+0x246>
    8020045c:	c11ff0ef          	jal	ra,8020006c <cprintf>
                num++;
    80200460:	00004717          	auipc	a4,0x4
    80200464:	bb070713          	addi	a4,a4,-1104 # 80204010 <edata>
                ticks = 0;
    80200468:	00004797          	auipc	a5,0x4
    8020046c:	ba07b823          	sd	zero,-1104(a5) # 80204018 <ticks>
                num++;
    ...
    80200480:	fcd795e3          	bne	a5,a3,8020044a <interrupt_handler+0x84>

0000000080200484 <illegal_instruction>:
    80200484:	0000                	unimp
    80200486:	0000                	unimp
                __asm__ volatile ("ebreak");
    80200488:	9002                	ebreak
}
...
void exception_handler(struct trapframe *tf) {
    ...
    802004e0:	70450513          	addi	a0,a0,1796 # 80200be0 <etext+0x16e>
    ...
    802004fe:	70650513          	addi	a0,a0,1798 # 80200c00 <etext+0x18e>
    ...
    8020050e:	70e50513          	addi	a0,a0,1806 # 80200c18 <etext+0x1a6>
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    80200630:	bc478793          	addi	a5,a5,-1084 # 802011f0 <error_string+0x38>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200684:	9dca0a13          	addi	s4,s4,-1572 # 8020105c <etext+0x5ea>
    ...
    80200690:	b2cc0c13          	addi	s8,s8,-1236 # 802011b8 <error_string>
    ...
    8020077e:	b2660613          	addi	a2,a2,-1242 # 802012a0 <error_string+0xe8>
    ...
    80200912:	98260613          	addi	a2,a2,-1662 # 80201290 <error_string+0xd8>
    ...
    80200924:	96860613          	addi	a2,a2,-1688 # 80201288 <error_string+0xd0>
            if (width > 0 && padc != '-') {
    80200928:	00001417          	auipc	s0,0x1
    8020092c:	96140413          	addi	s0,s0,-1695 # 80201289 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
    ...
    802009b8:	8d540413          	addi	s0,s0,-1835 # 80201289 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
void sbi_set_timer(unsigned long long stime_value) {
    ...
    80200a06:	61e78793          	addi	a5,a5,1566 # 80204020 <SBI_SET_TIMER>
    __asm__ volatile (
